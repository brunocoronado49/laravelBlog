    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-3 offset-md-1">
            ...
            <div class="row mb-4">
                <div class="col-4 p-0">
                    <a href="#">
                        <img src="images/1.jpg" class="img-fluid rounded" width="100" alt="">
                    </a>
                </div>
            ...
            <div class="row mb-4">
                <div class="col-4 p-0">
                    <a href="#">
                        <img src="images/2.jpg" class="img-fluid rounded" width="100" alt="">
                    </a>
                </div>
                <div class="col-7 pl-0">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4 col-12 justify-content-center mb-5">
            <div class="card m-auto" style="width: 18rem;">
                <img class="card-img-top" src="{{asset('images/1.jpg')}}" alt="Post Python">
                <div class="card-body">
        ...
        <div class="col-md-4 col-12 justify-content-center mb-5">
            <div class="card m-auto" style="width: 18rem;">
                <img class="card-img-top" src="{{asset('images/2.jpg')}}" alt="Post Python">
                <div class="card-body">
                    <small class="card-txt-category">Categoría: Programación</small>
                    <h5 class="card-title my-2">Aprende Python en un dos tres</h5>
                    <div class="d-card-text">
        ...
        <div class="col-md-4 col-12 justify-content-center mb-5">
            <div class="card m-auto" style="width: 18rem;">
                <img class="card-img-top" src="{{asset('images/3.jpg')}}" alt="Post Python">
                <div class="card-body">
                    <small class="card-txt-category">Categoría: Programación</small>
                    <h5 class="card-title my-2">Aprende Python en un dos tres</h5>
                    <div class="d-card-text">
